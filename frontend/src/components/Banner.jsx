  ...
  return (
    <div>
        ...
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white text-center mb-4 font-accent fade-in">
            Why Choose EduMinds
          </h2>
          <p className="text-lg text-gray-600 dark:text-gray-400 text-center max-w-3xl mx-auto mb-16 fade-in">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-gray-50 dark:bg-slate-800 rounded-xl p-8 text-center shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-1 zoom-in" style={{animationDelay: '0.1s'}}>
            ...
            {/* Feature 2 */}
            <div className="bg-gray-50 dark:bg-slate-800 rounded-xl p-8 text-center shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-1 zoom-in" style={{animationDelay: '0.2s'}}>
            ...
            {/* Feature 3 */}
            <div className="bg-gray-50 dark:bg-slate-800 rounded-xl p-8 text-center shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-1 zoom-in" style={{animationDelay: '0.3s'}}>
              <div className="feature-icon-container bg-primary/10 dark:bg-primary/20">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
