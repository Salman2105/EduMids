      ...
      <main className="text-center py-20 px-4">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-8 mt-10">
          ...
          <div className="bg-white rounded shadow p-6 w-full max-w-sm">
            ...
            <p>
               <img src="/assets/Teacher2.jpg" alt="landpagege" />Create and manage courses, lessons, and student enrollments.</p>
          </div>
          <div className="bg-white rounded shadow p-6 w-full max-w-sm">
            <h3 className="text-xl font-semibold text-blue-600 mb-2">Admins</h3>
            <p>
              <img src="/assets/Admin.png" alt="landpagege" />Oversee the entire platform, generate reports, and manage users.</p>
          </div>
        </div>
      </main>
    </div>
